...
class ProfessionalRegister extends StatefulWidget {
  @override
  _ProfessionalRegisterState createState() => _ProfessionalRegisterState();
}

class _ProfessionalRegisterState extends State<ProfessionalRegister> {
                      ...
                      SizedBox(
                        ...
                        child: Center(
                          child: TextFormField(
                            ...
                            validator: (value) => value!.isEmpty
                                ?  "Veuillez renseigner une adresse postale valide"
                                : null,
                            textAlign: TextAlign.left,
                            obscureText: false,
                            decoration: const InputDecoration(
